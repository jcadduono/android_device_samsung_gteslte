...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --board SRPPB03A000RU
...
TARGET_PREBUILT_KERNEL := device/samsung/gteslte/zImage
TARGET_PREBUILT_DTB := device/samsung/gteslte/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/gteslte/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/gteslte/init/init_gteslte.cpp
